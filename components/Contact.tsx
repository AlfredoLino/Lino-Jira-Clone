  ...
  return (
    ...
    <Grid py={'1rem'} container gap={2} justifyContent={'space-around'}>
      <Grid item lg = {6} xl={3}>
        ...
        <GradientHeader text='https://github.com/AlfredoLino' v='h4' />
      </Grid>
      <Grid item lg = {6} xl={3}>
        <Image src={'/gmail.svg'} alt='Github logo' width={300} height={300} />
        <GradientHeader text='alfredolinomendoza@gmail.com' v='h4' />
      </Grid>
      <Grid item lg = {12} xl={3}>
        <Image src={'/linkedin.svg'} alt='Github logo' width={300} height={300} />
        <GradientHeader text='www.linkedin.com/in/alfredolino/'  v='h4'/>
      </Grid>
    </Grid>
  </Box>
  )
